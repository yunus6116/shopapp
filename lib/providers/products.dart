...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndSetProducts([bool filterByUser = false]) async {
    ...
    var url =
        'https://flutter-crash-course-5e6ae.firebaseio.com/products.json?auth=$authToken&$filterString';
    try {
      ...
      url =
          'https://flutter-crash-course-5e6ae.firebaseio.com/userFavorites/$userId.json?auth=$authToken';
